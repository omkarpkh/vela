...
// Every component in its states on one page. The visual-regression baselines are taken here,
// section by section, so this page's markup is deliberately stable.
  ...
  return (
    <>
      <header className="page-head">
        ...
        <p className="vela-meta">6 components · 76 contrast pairs asserted in both themes · switch the theme in the top bar</p>
      </header>
